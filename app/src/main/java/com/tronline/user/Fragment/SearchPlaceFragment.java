...
import com.tronline.user.Utils.MarkerUtils.SmoothMoveMarker;
...
public class SearchPlaceFragment extends BaseMapFragment implements View.OnClickListener, LocationHelper.OnLocationReceived, OnMapReadyCallback {
    ...
    private LatLng des_latLng,sourceLatLng,stop_latLng;
    ...
    private void getCompleteAddressSource(LatLng target) {
        ...
        Log.d("mahi", "map for address" + map);
        new VollyRequester(activity, Const.GET, map, Const.ServiceCode.GEO_DEST, this);
    }
                            ...
                            public void run() {
                               ...
                               //     parseLocationDetails(response);
                                    ...
                                    if (null != PickUpMarker) {
                                        ...
                                        googleMap.animateCamera(CameraUpdateFactory.newLatLngZoom(sourceLatLng,
                                                16));
                                    }
